...
class AgentConfigTests(unittest.TestCase):
    ...
    def test_volcengine_provider_is_inferred_from_base_url(self):
        self.assertEqual(api_provider_from_base_url("https://ark.cn-beijing.volces.com/api/v3"), "volcengine")
        self.assertEqual(api_provider_from_base_url("https://ark.cn-beijing.volces.com"), "volcengine")
